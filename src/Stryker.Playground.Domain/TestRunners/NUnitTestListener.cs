// Forked from https://github.com/nunit/nunit/blob/master/src/NUnitFramework/nunitlite/TextRunner.cs
...
{	
    ...
    {	
        ...
        private ITestAssemblyRunner _runner = null!;	

        private NUnitLiteOptions _options = null!;	
        private ITestListener _teamCity = null!;	

        private TextUI _textUI = null!;	

        #region Constructors	

        public NUnitTestListener(Assembly testAssembly)	
        {	
        ...
        public ResultSummary Summary { get; private set; } = null!;
