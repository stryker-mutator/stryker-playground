...
namespace Stryker.Core.Common.InjectedHelpers
{
    public static class CodeInjection
    {
        // files to be injected into the mutated assembly
        private static readonly string[] Files = {"Stryker.Core.Common.InjectedHelpers.MutantControl.cs",
            "Stryker.Core.Common.InjectedHelpers.Coverage.MutantContext.cs"};
        ...
        {
            var helper = GetSourceFromResource("Stryker.Core.Common.InjectedHelpers.MutantControl.cs");
